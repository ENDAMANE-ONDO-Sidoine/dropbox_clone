...
import { API,GraphQLAPI, graphqlOperation } from '@aws-amplify/api-graphql'; 
...
export default function FileUpload({ user }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const result = await API.GraphQLAPI.graphql(graphqlOperation(createFile, fileDetails.input));
