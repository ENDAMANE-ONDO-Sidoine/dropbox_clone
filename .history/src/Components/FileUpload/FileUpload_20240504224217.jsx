...
import Amplify, { API as AmplifyAPI, Storage as AmplifyStorage } from 'aws-amplify';
...
export default function FileUpload({ user }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const uploadedFile = await AmplifyStorage.uploadData(storagePath, file, {
      ...
      const newFile = await AmplifyAPI.graphql({
        query: createFile,
