...
export default function FileUpload({ user }) {
  ...
  return (
    <div className="p-4 w-[95%] border border-gray-200 rounded flex  items-center mx-auto">
        
      <input type="file" onChange={handleFileChange} className="border-blue-600 bg-teal-200" />
