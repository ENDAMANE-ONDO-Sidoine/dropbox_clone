...
import { API, graphqlOperation } from 'aws-amplify/api'; // Modification de l'importation
...
export default function FileUpload({ user }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await API.graphql(graphqlOperation(createFile, { input: fileDetails.input })); // Utilisation de API.graphql et graphqlOperation correctement
