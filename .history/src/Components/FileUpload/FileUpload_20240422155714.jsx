...
return (
    <div className=' p-[8%] rounded shadow transform transition duration-500 ease-in-out hover:scale-y-500 flex gap-4 items-center justify-center h-full bg-slate-300 w-[93%] mx-auto'>
