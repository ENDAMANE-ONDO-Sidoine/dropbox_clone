...
const FileUploader = () => {
    ...
    import { FaUpload } from 'react-icons/fa'; // Importer l'icône d'upload
import './App.css'; // Importer le fichier CSS

return (
    <div className='flex items-center justify-center h-full'>
        <input type="file" className="my-4 p-2 border-2 border-blue-500 rounded" onChange={onFileChange} />
        <button className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-green-700 flex items-center"  onClick={onFileUpload}>
