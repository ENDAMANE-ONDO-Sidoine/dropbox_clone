...
import { GraphQLAPI, graphqlOperation } from '@aws-amplify/api-graphql'; // Importation directe des opérations GraphQL
...
export default function FileUpload({ user }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const result = await GraphQLAPI.graphql(graphqlOperation(createFile, fileDetails.input));
      console.log('CreateFile result:', result); // Logging the output of createFile mutation
