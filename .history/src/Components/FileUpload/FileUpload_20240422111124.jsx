...
const FileUploader = () => {
    ...
    return (
        <div className='m-5  border-4 border-green-500 bg-pink-600 p-10'>
            <input type="file" className="mb-3" onChange={onFileChange} />
            <button className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700"  onClick={onFileUpload}>Upload File</button>
