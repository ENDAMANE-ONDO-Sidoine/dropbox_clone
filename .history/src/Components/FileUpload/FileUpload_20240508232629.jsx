...
import { GraphQLAPIClass, graphqlOperation } from '@aws-amplify/api-graphql'; 
import { destroyAmplifyServerContext } from '@aws-amplify/core/internals/adapter-core';
...
export default function FileUpload({ user }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const result = await @destroyAmplifyServerContext.graphql(graphqlOperation(createFile, fileDetails.input));
