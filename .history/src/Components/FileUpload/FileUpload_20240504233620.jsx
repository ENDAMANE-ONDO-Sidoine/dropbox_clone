import React, { useState } from 'react'; // Importer useState correctement
import { Amplify, API, Storage } from 'aws-amplify'; // Utiliser les exportations nommées
import awsExports from '../../aws-exports'; // Vérifiez que le chemin d'importation est correct
