...
import Amplify from 'aws-amplify'; // Importation d'Amplify pour la configuration générale
import { API, graphqlOperation } from '@aws-amplify/api'; // Importation spécifique pour API
import { Storage } from '@aws-amplify/storage'; // Importation spécifique pour Storage
import awsExports from '../../aws-exports';
import { createFile } from '../../graphql/mutations';
import { FaUpload } from 'react-icons/fa';

// Configure Amplify avec les configurations exportées d'AWS
