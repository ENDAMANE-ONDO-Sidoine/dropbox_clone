...
import { GraphQLAPIClass, GraphQLAPIClass, graphqlOperation } from '@aws-amplify/api-graphql'; 
...
export default function FileUpload({ user }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const result = await GraphQLAPIClass.graphql(graphqlOperation(createFile, fileDetails.input));
