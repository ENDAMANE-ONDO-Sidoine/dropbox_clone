...
export default function FileList() {
  ...
  const [searchTerm, setSearchTerm] = useState(''); // Ajoutez un état pour le terme de recherche
  ...
  return (
    <div className="px-12">
      ...
      <SearchBar searchTerm={searchTerm} setSearchTerm={setSearchTerm} /> {/* Utilisez le composant SearchBar ici */}
      {isLoading ? (
        <p>Loading files...</p>
      ) : error ? (
        <p>{error}</p>
